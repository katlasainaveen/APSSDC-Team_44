package com.example.recipeapp2.Lunch;
...
public class Lunch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.back_btn_lunch);
        ...
        recycler = findViewById(R.id.lunch_recycler);
        recycler.setLayoutManager(new LinearLayoutManager(Lunch.this));

        Query query = FirebaseFirestore.getInstance().collection("Lunch");
        ...
        adapter = new FirestoreRecyclerAdapter<Recycler_total, LunchViewHolder>(options) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull LunchViewHolder holder, int position, @NonNull Recycler_total model) {
                holder.title.setText(model.getName());
                holder.description.setText(model.getDescription());
                holder.time.setText(model.getTotaltime());
                holder.rating.setRating(model.getRating());
                Glide.with(Lunch.this)
    ...
    private class LunchViewHolder extends RecyclerView.ViewHolder {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        Intent news = new Intent(Lunch.this, Tap_item.class);
