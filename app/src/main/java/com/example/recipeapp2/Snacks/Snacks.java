package com.example.recipeapp2.Snacks;
...
public class Snacks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.back_btn_snacks);
        ...
        recycler = findViewById(R.id.snacks_recycler);
        recycler.setLayoutManager(new LinearLayoutManager(Snacks.this));

        Query query = FirebaseFirestore.getInstance().collection("Snacks");
        ...
        adapter = new FirestoreRecyclerAdapter<Recycler_total, SnacksViewHolder>(options) {
            @NonNull
            @Override
            ...
            @Override
            protected void onBindViewHolder(@NonNull SnacksViewHolder holder, int position, @NonNull Recycler_total model) {
                holder.title.setText(model.getName());
                holder.description.setText(model.getDescription());
                holder.time.setText(model.getTotaltime());
                holder.rating.setRating(model.getRating());
                Glide.with(Snacks.this)
    ...
    private class SnacksViewHolder extends RecyclerView.ViewHolder {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        Intent news = new Intent(Snacks.this, Tap_item.class);
